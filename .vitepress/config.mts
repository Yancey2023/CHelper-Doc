...
export default defineConfig({
  title: "CHelper",
  description: "CHelper是一个我的世界基岩版的命令助手，致力于为我的世界指令玩家提供帮助。",
  lang: 'zh-CN',
  cleanUrls: true,
  srcDir: './src',
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        text: '二次开发',
        items: [
          { text: 'CHelper 安卓接口 / Java 接口文档', link: '/development/android' },
          { text: 'CHelper 内核文档', link: '/development/core' },
          { text: 'CHelper 网页接口 / JavaScript 接口文档', link: '/development/web' },
        ]
      },
    ],
    ...
    footer: {
      ...
      message: '<a href="https://beian.miit.gov.cn/shouye.html">粤ICP备2024307783号</a>'
    },
  },
